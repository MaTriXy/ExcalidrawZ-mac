//
//  ArrowheadCowsFootOneOrMany.swift
//  ExcalidrawZ
//
...
struct ArrowheadCowsFootOneOrMany: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.addLine(to: CGPoint(x: 0.375*width, y: 0.8*height))
        path.addLine(to: CGPoint(x: 0.375*width, y: 0.2*height))
        path.move(to: CGPoint(x: 0.375*width, y: 0.5*height))
